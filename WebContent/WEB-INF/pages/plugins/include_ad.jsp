<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="carouselMenu" class="carousel slide" data-interval="200"
	data-wrap="true">
	<!-- 轮播（Carousel）索引控制 -->
	...
	<div class="carousel-inner">
		<div class="item active">
			<a href="#" target="_ablank"><img
				src="upload/ad/ads-pic-01.jpg" alt="f1Img"></a>
		</div>
		<div class="item">
			<a href="#" target="_ablank"><img
				src="upload/ad/ads-pic-02.jpg" alt="f2Img"></a>
		</div>
		<div class="item">
			<a href="#" target="_ablank"><img
				src="upload/ad/ads-pic-03.jpg" alt="f3Img"></a>
		</div>
		<div class="item">
			<a href="#" target="_ablank"><img
				src="upload/ad/ads-pic-04.jpg" alt="f4Img"></a>
		</div>
		<div class="item">
			<a href="#" target="_ablank"><img
				src="upload/ad/ads-pic-05.jpg" alt="f5Img"></a>
		</div>
	</div>
	<!-- 轮播（Carousel）导航 -->
	<a class="carousel-control left" href="#carouselMenu" data-slide="prev">&lsaquo;</a>
	<!-- 显示前一个轮播项内容 -->
