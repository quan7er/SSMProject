			...
			<div class="col-md-12">
				<div class="panel panel-info">
					<div class="panel-heading">
						<strong><span class="glyphicon glyphicon-user"></span>&nbsp;内部用户登录</strong>
					</div>
					<div class="panel-body">
						<form action="<%=loginUrl%>" id="myform" method="post"
							class="form-horizontal">
							<div class="form-group" id="midDiv">
								<label class="col-md-2 control-label" for="mid">登录账号：</label>
								<div class="col-md-5">
									<input type="text" name="mid" id="mid"
										class="form-control input-sm" placeholder="请输入管理员为您提供的帐号...">
								</div>
