			...
			<div class="col-md-12">
				<div class="panel panel-info">
					<div class="panel-heading">
						<strong><span class="glyphicon glyphicon-calendar"></span>&nbsp;访问预约</strong>
					</div>
					<div class="panel-body">
						...
						<form action="<%=bespeakAddUrl%>" id="myform" method="post"
							...
							<div class="form-group" id="nameDiv">
								...
								<div class="col-md-5">
									<input type="text" name="name" id="name"
										class="form-control input-sm" placeholder="请输入您的姓名...">
								</div>
							...
							<div class="form-group" id="schoolDiv">
								...
								<div class="col-md-5">
									<input type="text" name="school" id="school"
										class="form-control input-sm" placeholder="请输入您的毕业院校...">
								</div>
							...
							<div class="form-group" id="bedateDiv">
								...
								<div class="col-md-5">
									<input type="text" id="bedate" name="bedate" onclick="laydate()"
										class="form-control input-sm laydate-icon"
										placeholder="请选择您的的预约日期...">
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="benoteDiv">
								...
								<div class="col-md-5">
									<textarea rows="6" name="benote" id="benote"
										class="form-control input-sm" placeholder="请输入您的相关需求..."></textarea>
								</div>
