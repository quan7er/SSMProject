			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<table class="table table-bordered table-hover">
						<tr>
							<td colspan="3"><span class="h1"><span
									class="glyphicon glyphicon-user"></span>&nbsp;欢迎“<shiro:principal />”光临！</span>
								<shiro:hasRole name="news">
									<shiro:hasPermission name="news:list">
										<button id="createNewsBut" class="btn btn-info btn-lg">
											<i class="fa fa-plus-circle"></i>&nbsp;生成公告信息列表
										</button>
									</shiro:hasPermission>
								</shiro:hasRole> <shiro:hasRole name="bespeak">
									<shiro:hasPermission name="bespeak:list">
										<button id="createBespeakBut" class="btn btn-success btn-lg">
											<i class="fa  fa-slideshare"></i>&nbsp;生成预约分类信息
										</button>
									</shiro:hasPermission>
								</shiro:hasRole></td>
						</tr>
						<tr>
							<td rowspan="6" style="width: 130px;"><img
								src="upload/news/nophoto.gif" class="image"
