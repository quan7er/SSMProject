						...
						<div class="form-group" id="midDiv">
							...
							<div class="col-md-5">
								<input type="text" class="form-control input-sm"
									value="${member.mid}" disabled="disabled">
							</div>
						...
						<div class="form-group" id="passwordDiv">
							...
							<div class="col-md-5">
								<input type="text" name="password" id="password"
									class="form-control input-sm" placeholder="如果要修改密码，请输入！">
							</div>
							...
							<div class="col-md-5">
								<c:forEach items="${allRoles}" var="role">
									<div class="checkbox-inline">
										<input type="checkbox" name="rid" id="rid" value="${role.rid}"
											${fn:contains(memberRoles,role.rid)? "checked":""}>${role.title}
									</div>
								</c:forEach>
							</div>
						...
						<div class="form-group" id="lockedDiv">
							...
							<div class="col-md-5">
								<div class="radio-inline">
									<input id="locked" name="locked" type="radio" value="0"
										${member.locked == 0 ? "checked":""}><span
										class="text-success">活跃</span>
								</div>
								<div class="radio-inline">
									<input id="locked" name="locked" type="radio" value="1"
										${member.locked == 1 ? "checked":""}><span
										class="text-success">锁定</span>
								</div>
							</div>
						</div>
