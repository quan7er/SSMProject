...
<script type="text/javascript"
	src="js/pages/back/member/member_password.js"></script>
</head>
						...
						<div class="form-group" id="newpasswordDiv">
							...
							<div class="col-md-5">
								<input type="password" name="newpassword" id="newpassword"
									class="form-control input-sm" placeholder="请输入新的登录密码...">
							</div>
						...
						<div class="form-group" id="confpasswordDiv">
							...
							<div class="col-md-5">
								<input type="password" name="confpassword" id="confpassword"
									class="form-control input-sm" placeholder="请重新输入新的登录密码...">
							</div>
