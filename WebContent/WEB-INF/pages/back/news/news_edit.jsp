		...
		<div class="content-wrapper">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form action="<%=editNewsUrl%>" id="myform" method="post"
						class="form-horizontal" enctype="multipart/form-data">
						<div class="form-group" id="titleDiv">
							<label class="col-md-2 control-label" for="title">公告标题：</label>
							<div class="col-md-5">
								<input type="text" name="title" id="title"
									class="form-control input-sm" value="${news.title}" placeholder="请输入公告标题">
							</div>
						...
						<div class="form-group" id="absDiv">
							...
							<div class="col-md-5">
								<input type="text" name="abs" id="abs"
									class="form-control input-sm" value="${news.abs}" placeholder="请输入公告摘要">
							</div>
						...
						<div class="form-group" id="typeDiv">
							...
							<div class="col-md-5">
								<select id="dtid" name="dtid" class="form-control">
									...
									<c:forEach items="${allNewsType}" var="dictionary">
										<option value="${dictionary.dtid}" ${dictionary.dtid == news.dtid? 'selected':''}>${dictionary.title}</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group" id="statusDiv">
							...
							<div class="col-md-5">
								<div class="radio-inline">
									<input type="radio" id="flag" name="flag" value="1" ${news.flag==1?'checked':''}>直接发布
								</div>
								<div class="radio-inline">
									<input type="radio" id="flag" name="flag" value="0" ${news.flag==0?'checked':''}>暂存草稿
								</div>
							</div>
